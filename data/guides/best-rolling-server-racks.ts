export const guideSlug = "best-rolling-server-racks";
export const guideTitle = "5 Best Rolling Server Racks in 2026";
export const metaTitle = "Best Rolling Server Racks 2026";
export const metaDescription = "We compared rolling server racks by documented weight rating, mounting depth, and post configuration rather than ranking by U-height alone.";
export const mainKeyword = "rolling server racks";
export const introParagraphs = [
  "A quick scan of rolling server racks listings rarely settles the question of checking how much weight capacity drops once a rack is actually rolling on its casters, so that's where we started.",
  "We compared this lineup on documented weight rating and mounting depth plus checking how much weight capacity drops once a rack is actually rolling on its casters, since a rack's nominal size alone regularly overstates what actually fits."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-rolling-server-racks-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-rolling-server-racks-2",
    rank: 2,
    badge: "Runner-Up",
  ...
  {
    id: "best-rolling-server-racks-3",
    rank: 3,
    badge: "Also Great",
  ...
  {
    id: "best-rolling-server-racks-4",
    rank: 4,
  ...
  {
    id: "best-rolling-server-racks-5",
    rank: 5,
    badge: "Budget Pick",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Confirm rolling server racks's weight rating specifically for caster-mounted use, since rolling capacity is documented separately and typically lower than the stationary rating."
  },
  {
...
export const buyingCriteria = [
  {
    ...
    "explanation": "Confirm rolling server racks's weight rating specifically for caster-mounted use, since rolling capacity is documented separately and typically lower than the stationary rating."
  },
  {
...
export const faq = [
  {
    "q": "What's the biggest mistake buyers make shopping for rolling server racks?",
  ...
  {
    "q": "Should I prioritize weight capacity or included accessories for rolling server racks?",
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-server-racks-on-wheels","title":"Best Server Racks on Wheels in 2026"},{"href":"/guide/best-portable-server-racks","title":"Best Portable Server Racks in 2026"},{"href":"/guide/best-mobile-server-racks","title":"Best Mobile Server Racks in 2026"}];
