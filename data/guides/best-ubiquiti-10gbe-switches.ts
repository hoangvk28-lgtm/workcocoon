export const guideSlug = "best-ubiquiti-10gbe-switches";
export const guideTitle = "6 Best Ubiquiti 10GbE Switches in 2026";
export const metaTitle = "Best Ubiquiti 10GbE Switches 2026";
export const metaDescription = "We compared ubiquiti 10gbe switches by verified port topology, switching capacity, and management depth rather than ranking by headline port count alone.";
export const mainKeyword = "ubiquiti 10gbe switches";
export const introParagraphs = [
  "Choosing among ubiquiti 10gbe switches means starting with mapping the brand's current model lineup instead of assuming every listing is current rather than price or star rating.",
  "Every entry on this list was screened for verified port topology plus mapping the brand's current model lineup instead of assuming every listing is current before anything else was weighed."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-ubiquiti-10gbe-switches-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-ubiquiti-10gbe-switches-2",
    rank: 2,
    badge: "Runner-Up",
  ...
  {
    id: "best-ubiquiti-10gbe-switches-3",
    rank: 3,
    badge: "Also Great",
  ...
  {
    id: "best-ubiquiti-10gbe-switches-4",
    rank: 4,
  ...
  {
    id: "best-ubiquiti-10gbe-switches-5",
    rank: 5,
  ...
  {
    id: "best-ubiquiti-10gbe-switches-6",
    rank: 6,
    badge: "Budget Pick",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Confirm which ubiquiti 10gbe switches models are currently sold rather than assuming an older listing reflects the current lineup, since old support pages stay heavily indexed."
  },
  {
...
export const buyingCriteria = [
  {
    ...
    "explanation": "Confirm which ubiquiti 10gbe switches models are currently sold rather than assuming an older listing reflects the current lineup, since old support pages stay heavily indexed."
  },
  {
...
export const faq = [
  {
    "q": "Are all ubiquiti 10gbe switches models currently sold and supported?",
