export const guideSlug = "best-aruba-10gbe-switches";
export const guideTitle = "6 Best Aruba 10GbE Switches in 2026";
export const metaTitle = "Best Aruba 10GbE Switches 2026";
export const metaDescription = "We compared aruba 10gbe switches by verified port topology, switching capacity, and management depth rather than ranking by headline port count alone.";
export const mainKeyword = "aruba 10gbe switches";
export const introParagraphs = [
  "Best Aruba 10GbE Switches deserves topology-specific scrutiny before ranking, since this category comes down to mapping the brand's current model lineup instead of assuming every listing is current.",
  "Each pick here was judged on verified port topology plus mapping the brand's current model lineup instead of assuming every listing is current, not just its price tag."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-aruba-10gbe-switches-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-aruba-10gbe-switches-2",
    rank: 2,
    badge: "Runner-Up",
  ...
  {
    id: "best-aruba-10gbe-switches-3",
    rank: 3,
    badge: "Also Great",
  ...
  {
    id: "best-aruba-10gbe-switches-4",
    rank: 4,
  ...
  {
    id: "best-aruba-10gbe-switches-5",
    rank: 5,
  ...
  {
    id: "best-aruba-10gbe-switches-6",
    rank: 6,
    badge: "Budget Pick",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Confirm which aruba 10gbe switches models are currently sold rather than assuming an older listing reflects the current lineup, since old support pages stay heavily indexed."
  },
  {
...
export const buyingCriteria = [
  {
    ...
    "explanation": "Confirm which aruba 10gbe switches models are currently sold rather than assuming an older listing reflects the current lineup, since old support pages stay heavily indexed."
  },
  {
...
export const faq = [
  {
    "q": "Are all aruba 10gbe switches models currently sold and supported?",
