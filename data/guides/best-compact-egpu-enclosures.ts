export const guideSlug = "best-compact-egpu-enclosures";
export const guideTitle = "7 Best Compact eGPU Enclosures in 2026";
export const metaTitle = "Best Compact eGPU Enclosures 2026";
export const metaDescription = "We compared compact egpu enclosures by documented host-link architecture, GPU fit, and power supply rather than ranking by bandwidth headlines alone.";
export const mainKeyword = "compact egpu enclosures";
export const introParagraphs = [
  "Most compact egpu enclosures buyers skip straight to bandwidth claims, when the more useful first step is verifying complete setup size including PSU, cables, and power brick, not the shell alone.",
  "What separates these picks is documented host-link architecture plus verifying complete setup size including PSU, cables, and power brick, not the shell alone, checked model by model."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-compact-egpu-enclosures-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-compact-egpu-enclosures-2",
    rank: 2,
    badge: "Runner-Up",
  ...
  {
    id: "best-compact-egpu-enclosures-3",
    rank: 3,
    badge: "Also Great",
  ...
  {
    id: "best-compact-egpu-enclosures-4",
    rank: 4,
  ...
  {
    id: "best-compact-egpu-enclosures-5",
    rank: 5,
  ...
  {
    id: "best-compact-egpu-enclosures-6",
    rank: 6,
    badge: "Solid Option",
  ...
  {
    id: "best-compact-egpu-enclosures-7",
    rank: 7,
    badge: "Budget Pick",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Check compact egpu enclosures's total footprint including GPU, PSU, power brick, and cables, not the empty shell dimensions alone."
  },
  {
...
export const buyingCriteria = [
  {
    ...
    "explanation": "Check compact egpu enclosures's total footprint including GPU, PSU, power brick, and cables, not the empty shell dimensions alone."
  },
  {
...
export const faq = [
  {
    "q": "How much does the complete compact egpu enclosures setup actually weigh once packed?",
