export const guideSlug = "best-tp-link-10gbe-switches";
export const guideTitle = "7 Best TP-Link 10GbE Switches in 2026";
export const metaTitle = "Best TP-Link 10GbE Switches 2026";
export const metaDescription = "We compared tp-link 10gbe switches by verified port topology, switching capacity, and management depth rather than ranking by headline port count alone.";
export const mainKeyword = "tp-link 10gbe switches";
export const introParagraphs = [
  "The real test for tp-link 10gbe switches comes down to verifying management tier and firmware support for the exact SKU, not the brand name, not a glance at the listing photo.",
  "Rather than trust manufacturer claims, we checked verified port topology plus verifying management tier and firmware support for the exact SKU, not the brand name for every switch on this list."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-tp-link-10gbe-switches-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-tp-link-10gbe-switches-2",
    rank: 2,
    badge: "Runner-Up",
  ...
  {
    id: "best-tp-link-10gbe-switches-3",
    rank: 3,
    badge: "Also Great",
  ...
  {
    id: "best-tp-link-10gbe-switches-4",
    rank: 4,
  ...
  {
    id: "best-tp-link-10gbe-switches-5",
    rank: 5,
  ...
  {
    id: "best-tp-link-10gbe-switches-6",
    rank: 6,
    badge: "Budget Pick",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Confirm which tp-link 10gbe switches models are currently sold rather than assuming an older listing reflects the current lineup, since old support pages stay heavily indexed."
  },
  {
...
export const buyingCriteria = [
  {
    ...
    "explanation": "Confirm which tp-link 10gbe switches models are currently sold rather than assuming an older listing reflects the current lineup, since old support pages stay heavily indexed."
  },
  {
...
export const faq = [
  {
    "q": "Are all tp-link 10gbe switches models currently sold and supported?",
