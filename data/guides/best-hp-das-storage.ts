export const guideSlug = "best-hp-das-storage";
export const guideTitle = "Best HP DAS Storage in 2026";
export const metaTitle = "Best HP DAS Storage in 2026";
export const metaDescription = "Modern enterprise DAS from this brand is sold under HPE. We cover the legacy HP D2700 alongside current general-purpose DAS alternatives.";
export const mainKeyword = "hp das storage";
export const introParagraphs = [
  "Modern enterprise direct-attached storage from this brand is documented and sold under the HPE name rather than legacy HP branding. The legacy HP D2700 SAS disk enclosure remains findable and functional, but HPE's current D3000 series is the actively supported successor line.",
  "We're covering the legacy HP unit here for buyers specifically searching that name, alongside genuinely strong desktop DAS alternatives for anyone not tied to enterprise SAS infrastructure."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-hp-das-storage-1",
    rank: 1,
    badge: "Legacy HP D2700 SAS Enclosure",
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "HP vs HPE Naming",
    "note": "For current enterprise direct-attached storage under this brand, search HPE D3000 (D3610/D3710) rather than legacy HP model numbers. The legacy D2700 remains functional but sits outside HPE's actively maintained documentation."
  }
];
...
export const faq = [
  {
    "q": "Is the HP D2700 still supported?",
    "a": "It remains functional hardware, but current HPE documentation and support focus on the D3000 series (D3610/D3710) as the actively maintained direct-attached storage line. Treat the D2700 as legacy hardware without guaranteed current firmware or support."
  },
  {
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-hpe-das-storage","title":"Best HPE DAS Storage in 2026"},{"href":"/guide/best-sas-das-storage","title":"6 Best SAS DAS Storage Solutions"},{"href":"/guide/best-12-bay-direct-attached-storage","title":"5 Best 12-Bay Direct-Attached Storage"}];
