...
export const guideTitle = "The Best Ergonomic Keyboards Among Amazon's Best Sellers, Checked for Real Split Layout and Desk Fit";
export const metaTitle = "Best Ergonomic Keyboards on Amazon (2026) | WorkCocoon";
export const metaDescription =
  "5 genuinely ergonomic keyboards pulled from Amazon's best-selling lineup, filtered from boards that just wear the label loosely. Compares true split vs. wave layout, wrist rest depth, and how much desk footprint each design adds on a compact desk.";
...
export const introParagraphs = [
  ...
  "On a small or shared desk, the wrist rest matters almost as much as the layout itself, a non-removable rest can add several inches of depth that eats into the space you need for a mouse. Below are 5 ergonomic keyboards compared on wrist rest depth, wave versus true split construction, wireless range, and desk footprint, ranging from a $44.99 wired split board to a $148.99 multi-device wireless split keyboard with a memory foam rest.",
...
export const products: GuideProduct[] = [
  {
    ...
    description: "The Ergo K860 is the only pick in this list with a genuinely separated key layout, split into two angled halves rather than a single curved wave surface. That distinction matters because a wave keyboard still forces both hands to sit shoulder-width apart from each other on one continuous frame, while this one lets each half be positioned independently.\n\nIt's the priciest pick here, but the price buys a dense memory foam rest across the full width and Bluetooth pairing with up to 3 devices, features the wave-style Logitech pick below doesn't match.\n\nSkip it if you don't need a dedicated numpad, or a true split layout is more separation than you want to adjust to; the Wave Keys picks below deliver most of the ergonomic benefit with a shorter learning curve.",
  ...
  },
  {
    ...
    description: "Wave Keys uses a curved, wave-shaped key deck rather than a true split, worth being clear about since wave keyboards are often loosely marketed as split even though both hands stay on one continuous frame that can't be pulled shoulder-width apart. The curve still reduces wrist bend compared to a flat board, just not to the same degree as a real split layout.\n\nAt roughly a third of the Ergo K860's price, it's a reasonable entry point into wave-style ergonomics, with a rocking cushioned palm rest that adjusts to your wrist angle as you type.\n\nSkip it if you specifically want independently positioned halves; the smaller key spacing here also makes it a tighter fit for larger hands than the true split picks below.",
  ...
  },
  {
    ...
    description: "The Perixx PERIBOARD-512B pairs a genuinely split key section with a wired USB connection, the cheapest way in this list to get a real split layout instead of a single-piece wave curve. Its firmer wrist rest is molded plastic rather than memory foam, trading softness for a surface that won't compress or flatten over years of use.\n\nAt under $45, it undercuts every wireless split option here while still delivering the ergonomic benefit that actually matters: physical separation between your hands.\n\nSkip it if you want Bluetooth or a softer wrist rest; the wired-only connection and firm plastic rest are the real cost of this price point.",
...
export const relatedGuides: { href: string; title: string }[] = [
  { href: "/desk-setup/best-mechanical-keyboards-under-60-100-budget", title: "Best Mechanical Keyboards Under $60/$100 Budget (2026)" },
  { href: "/desk-setup/best-mechanical-keyboard-layouts-explained", title: "Mechanical Keyboard Layouts Explained + Picks (2026)" },
