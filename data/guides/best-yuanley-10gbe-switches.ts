export const guideSlug = "best-yuanley-10gbe-switches";
export const guideTitle = "8 Best YuanLey 10GbE Switches in 2026";
export const metaTitle = "Best YuanLey 10GbE Switches 2026";
export const metaDescription = "We compared yuanley 10gbe switches by verified port topology, switching capacity, and management depth rather than ranking by headline port count alone.";
export const mainKeyword = "yuanley 10gbe switches";
export const introParagraphs = [
  "A quick scan of yuanley 10gbe switches listings rarely settles the question of checking exact port topology and switching capacity by specific model, so that's where we started.",
  "We compared this lineup on verified port topology plus checking exact port topology and switching capacity by specific model, since headline specs alone regularly overstate real throughput."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-yuanley-10gbe-switches-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-yuanley-10gbe-switches-2",
    rank: 2,
    badge: "Runner-Up",
  ...
  {
    id: "best-yuanley-10gbe-switches-3",
    rank: 3,
    badge: "Also Great",
  ...
  {
    id: "best-yuanley-10gbe-switches-4",
    rank: 4,
  ...
  {
    id: "best-yuanley-10gbe-switches-5",
    rank: 5,
  ...
  {
    id: "best-yuanley-10gbe-switches-6",
    rank: 6,
    badge: "Budget Pick",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Confirm which yuanley 10gbe switches models are currently sold rather than assuming an older listing reflects the current lineup, since old support pages stay heavily indexed."
  },
  {
...
export const buyingCriteria = [
  {
    ...
    "explanation": "Confirm which yuanley 10gbe switches models are currently sold rather than assuming an older listing reflects the current lineup, since old support pages stay heavily indexed."
  },
  {
...
export const faq = [
  {
    "q": "Are all yuanley 10gbe switches models currently sold and supported?",
