export const guideSlug = "best-server-racks-for-home";
export const guideTitle = "8 Best Server Racks for Home in 2026";
export const metaTitle = "Best Server Racks for Home 2026";
export const metaDescription = "We compared server racks for home by documented weight rating, mounting depth, and post configuration rather than ranking by U-height alone.";
export const mainKeyword = "server racks for home";
export const introParagraphs = [
  "The real test for server racks for home comes down to planning noise, heat, and branch circuit load like a real home installation, not a data center, not a glance at the listing photo.",
  "Rather than trust listing photos, we checked documented weight rating and mounting depth plus planning noise, heat, and branch circuit load like a real home installation, not a data center for every rack on this list."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-server-racks-for-home-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-server-racks-for-home-2",
    rank: 2,
    badge: "Runner-Up",
  ...
  {
    id: "best-server-racks-for-home-3",
    rank: 3,
    badge: "Also Great",
  ...
  {
    id: "best-server-racks-for-home-4",
    rank: 4,
  ...
  {
    id: "best-server-racks-for-home-5",
    rank: 5,
  ...
  {
    id: "best-server-racks-for-home-6",
    rank: 6,
    badge: "Solid Option",
  ...
  {
    id: "best-server-racks-for-home-7",
    rank: 7,
    badge: "Another Pick",
  ...
  {
    id: "best-server-racks-for-home-8",
    rank: 8,
    badge: "Budget Pick",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Confirm server racks for home won't push the total connected load past your home's branch circuit rating, since a PDU distributes outlets but not extra circuit capacity."
  },
  {
...
export const buyingCriteria = [
  {
    ...
    "explanation": "Confirm server racks for home won't push the total connected load past your home's branch circuit rating, since a PDU distributes outlets but not extra circuit capacity."
  },
  {
...
export const relatedGuides: { href: string; title: string }[] = [{"href":"/guide/best-small-server-racks-for-home","title":"Best Small Server Racks for Home in 2026"},{"href":"/guide/best-server-racks","title":"Best Server Racks in 2026"},{"href":"/guide/best-server-racks-for-network","title":"Best Server Racks for Network in 2026"}];
