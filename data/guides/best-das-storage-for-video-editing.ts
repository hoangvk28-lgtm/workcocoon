export const guideSlug = "best-das-storage-for-video-editing";
export const guideTitle = "8 Best DAS Storage for Video Editing";
export const metaTitle = "Best DAS Storage for Video Editing";
export const metaDescription = "Sustained throughput and RAID level matter more than burst benchmarks for editing. We compared real documented multi-drive speed.";
export const mainKeyword = "das storage for video editing";
export const introParagraphs = [
  "Video editing is one of the strongest DAS workflows, but peak benchmark speed alone doesn't reveal sustained multicam performance or how much throughput drops during a RAID rebuild, both real considerations for an active editing project.",
  "We prioritized products with documented sustained throughput figures, including multi-drive combined speeds and RAID mode performance, over enclosures that only publish a theoretical link-rate number."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-das-storage-for-video-editing-1",
    rank: 1,
    badge: "Best High-Capacity HDD Array",
  ...
  {
    id: "best-das-storage-for-video-editing-2",
    rank: 2,
  ...
  {
    id: "best-das-storage-for-video-editing-3",
    rank: 3,
  ...
  {
    id: "best-das-storage-for-video-editing-4",
    rank: 4,
    badge: "Best Thunderbolt 5 NVMe",
  ...
  {
    id: "best-das-storage-for-video-editing-5",
    rank: 5,
    badge: "Best Value HDD Array",
  ...
  {
    id: "best-das-storage-for-video-editing-6",
    rank: 6,
    badge: "Best RAID for Active Projects",
  ...
  {
    id: "best-das-storage-for-video-editing-7",
    rank: 7,
    badge: "Best Quiet 4-Bay NVMe Array",
  ...
  {
    id: "best-das-storage-for-video-editing-8",
    rank: 8,
    badge: "Best Compact RAID Backup",
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "By Codec and Resolution",
    "table": {
      "headers": [
        "Workflow",
        "Best pick"
      ...
      "rows": [
        [
          "4K/6K RAW multicam editing",
          "TerraMaster D4 SSD NVMe (documented 3,224MB/s, 4 SSDs)"
        ],
        [
          "8K or heavy VFX work",
          "MOKiN 80Gbps or UGREEN 80Gbps NVMe"
        ],
        [
          "Large archive/scratch storage",
          "TerraMaster D6-320 (132TB HDD array)"
        ]
      ]
    }
  }
...
export const faq = [
  {
    "q": "Should I edit directly off a RAID array during a rebuild?",
    "a": "Avoid it when possible. RAID rebuild after a drive replacement consumes significant read/write bandwidth and can noticeably slow active editing, plan rebuilds for downtime rather than mid-project deadlines."
  },
  {
