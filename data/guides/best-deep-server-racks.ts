export const guideSlug = "best-deep-server-racks";
export const guideTitle = "8 Best Deep Server Racks in 2026";
export const metaTitle = "Best Deep Server Racks 2026";
export const metaDescription = "We compared deep server racks by documented weight rating, mounting depth, and post configuration rather than ranking by U-height alone.";
export const mainKeyword = "deep server racks";
export const introParagraphs = [
  "The real test for deep server racks comes down to confirming actual usable mounting depth against real server chassis length, not just cabinet depth, not a glance at the listing photo.",
  "Rather than trust listing photos, we checked documented weight rating and mounting depth plus confirming actual usable mounting depth against real server chassis length, not just cabinet depth for every rack on this list."
];
...
export const products: GuideProduct[] = [
  ...
  },
  {
    ...
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41LGNnEVqaL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B000IZ95CQ?tag=deskfinds0d-20",
    description: "A half-height enclosed cabinet at 22U, giving a smaller commercial-grade footprint than the full 42U StarTech cabinets while keeping the same 1764 lb weight rating and EIA/ECA-310-E compliance.\n\nAt 46.6 inches tall it's a genuinely manageable height for a home office or small server closet, without sacrificing the wheels and leveling feet found on the larger models.",
    ...
    bestFor: "buyers prioritizing 22u, 33\" deep, 46.6\" tall",
  },
  {
    id: "best-deep-server-racks-4",
    rank: 4,
  ...
  },
  {
    ...
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/41yp8NQxKbL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B082YJVBTV?tag=deskfinds0d-20",
    description: "This 18U wall cabinet lists both overall and usable mounting depth separately (24 inches overall, 20 inches usable), a genuinely helpful detail for confirming your equipment will actually fit before buying.\n\nIt supports up to 133 lbs when properly wall-mounted, with a top fan, two shelves, and a PDU all included for a complete setup out of the box.",
    ...
    bestFor: "buyers prioritizing 18u, 24\" overall / 20\" usable depth",
  },
  {
    id: "best-deep-server-racks-6",
    rank: 6,
    badge: "Solid Option",
  ...
  },
  {
    ...
    rating: null,
    reviews: null,
    imageUrl: "https://m.media-amazon.com/images/I/31c9kXcxbpL._SL500_.jpg",
    amazonUrl: "https://www.amazon.com/dp/B074WQK2B1?tag=deskfinds0d-20",
    description: "This is StarTech's enclosed, fully-assembled version of the 42U rack, shipping ready to load rather than flat-packed, with a 2000 lb stationary weight rating that's among the highest in this lineup.\n\nIndependent quick-release locks on the door and side panels mean you can pull a panel for servicing without unlocking the whole cabinet, a detail that saves time during maintenance.",
    ...
    bestFor: "buyers prioritizing 42u, adjustable 6-36\" mounting depth",
  }
];
...
export const howToChoose: HowToChooseSection[] = [
  {
    "subheading": "Confirm Usable Depth, Not Cabinet Depth",
    "note": "Verify deep server racks's usable mounting depth specifically, since overall cabinet depth includes wall thickness and door clearance that isn't available for equipment."
  },
  {
    "subheading": "Check Rear Clearance for Cable Bend Radius",
    "note": "Leave room behind the rack for cable bend radius and rear panel access, not just the raw equipment depth."
  },
  {
    "subheading": "Verify Stationary Weight Rating for Deep Gear",
    "note": "Confirm the stationary weight rating accounts for genuinely deep, heavy server chassis rather than lighter networking equipment."
  },
  {
    "subheading": "Check Room Depth Before Ordering",
    "note": "Measure actual room depth including doorway clearance for moving the assembled or flat-packed rack into place."
  },
  {
    "subheading": "Confirm Cooling Scales With Depth",
    "note": "Verify cooling fans or ventilation scale appropriately for the larger internal air volume a deep cabinet creates."
  }
];

export const buyingCriteria = [
  {
    "criterion": "Confirm Usable Depth, Not Cabinet Depth",
    "explanation": "Verify deep server racks's usable mounting depth specifically, since overall cabinet depth includes wall thickness and door clearance that isn't available for equipment."
  },
  {
    "criterion": "Check Rear Clearance for Cable Bend Radius",
    "explanation": "Leave room behind the rack for cable bend radius and rear panel access, not just the raw equipment depth."
  },
  {
    "criterion": "Verify Stationary Weight Rating for Deep Gear",
    "explanation": "Confirm the stationary weight rating accounts for genuinely deep, heavy server chassis rather than lighter networking equipment."
  },
  {
    "criterion": "Check Room Depth Before Ordering",
    "explanation": "Measure actual room depth including doorway clearance for moving the assembled or flat-packed rack into place."
  },
  {
    "criterion": "Confirm Cooling Scales With Depth",
    "explanation": "Verify cooling fans or ventilation scale appropriately for the larger internal air volume a deep cabinet creates."
  }
];

export const faq = [
  {
    "q": "What's the biggest mistake buyers make shopping for deep server racks?",
  ...
  {
    "q": "Should I prioritize weight capacity or included accessories for deep server racks?",
