export const guideSlug = "best-egpu-enclosures-for-rtx-5080";
export const guideTitle = "8 Best eGPU Enclosures for RTX 5080 in 2026";
export const metaTitle = "Best eGPU Enclosures for RTX 5080 2026";
export const metaDescription = "We compared egpu enclosures for rtx 5080 by documented host-link architecture, GPU fit, and power supply rather than ranking by bandwidth headlines alone.";
export const mainKeyword = "egpu enclosures for rtx 5080";
export const introParagraphs = [
  "Most egpu enclosures for rtx 5080 buyers skip straight to bandwidth claims, when the more useful first step is checking documented board dimensions and PSU connectors for the exact card, not the reference design.",
  "What separates these picks is documented host-link architecture plus checking documented board dimensions and PSU connectors for the exact card, not the reference design, checked model by model."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-egpu-enclosures-for-rtx-5080-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-egpu-enclosures-for-rtx-5080-2",
    rank: 2,
    badge: "Runner-Up",
  ...
  {
    id: "best-egpu-enclosures-for-rtx-5080-3",
    rank: 3,
    badge: "Also Great",
  ...
  {
    id: "best-egpu-enclosures-for-rtx-5080-4",
    rank: 4,
  ...
  {
    id: "best-egpu-enclosures-for-rtx-5080-5",
    rank: 5,
  ...
  {
    id: "best-egpu-enclosures-for-rtx-5080-6",
    rank: 6,
    badge: "Solid Option",
  ...
  {
    id: "best-egpu-enclosures-for-rtx-5080-7",
    rank: 7,
    badge: "Another Pick",
  ...
  {
    id: "best-egpu-enclosures-for-rtx-5080-8",
    rank: 8,
    badge: "Budget Pick",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Check the exact egpu enclosures for rtx 5080 board-partner card's length, height, and width rather than assuming all cards in that GPU family match the reference design."
  },
  {
...
export const buyingCriteria = [
  {
    ...
    "explanation": "Check the exact egpu enclosures for rtx 5080 board-partner card's length, height, and width rather than assuming all cards in that GPU family match the reference design."
  },
  {
...
export const faq = [
  {
    "q": "Does every egpu enclosures for rtx 5080 card fit the same eGPU enclosure?",
