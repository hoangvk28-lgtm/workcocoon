export const guideSlug = "best-trendnet-10gbe-switches";
export const guideTitle = "6 Best TRENDnet 10GbE Switches in 2026";
export const metaTitle = "Best TRENDnet 10GbE Switches 2026";
export const metaDescription = "We compared trendnet 10gbe switches by verified port topology, switching capacity, and management depth rather than ranking by headline port count alone.";
export const mainKeyword = "trendnet 10gbe switches";
export const introParagraphs = [
  "A quick scan of trendnet 10gbe switches listings rarely settles the question of mapping the brand's current model lineup instead of assuming every listing is current, so that's where we started.",
  "We compared this lineup on verified port topology plus mapping the brand's current model lineup instead of assuming every listing is current, since headline specs alone regularly overstate real throughput."
];
...
export const products: GuideProduct[] = [
  {
    id: "best-trendnet-10gbe-switches-1",
    rank: 1,
    badge: "Best Overall",
  ...
  {
    id: "best-trendnet-10gbe-switches-2",
    rank: 2,
    badge: "Runner-Up",
  ...
  {
    id: "best-trendnet-10gbe-switches-3",
    rank: 3,
    badge: "Also Great",
  ...
  {
    id: "best-trendnet-10gbe-switches-4",
    rank: 4,
  ...
  {
    id: "best-trendnet-10gbe-switches-5",
    rank: 5,
  ...
  {
    id: "best-trendnet-10gbe-switches-6",
    rank: 6,
    badge: "Budget Pick",
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Confirm which trendnet 10gbe switches models are currently sold rather than assuming an older listing reflects the current lineup, since old support pages stay heavily indexed."
  },
  {
...
export const buyingCriteria = [
  {
    ...
    "explanation": "Confirm which trendnet 10gbe switches models are currently sold rather than assuming an older listing reflects the current lineup, since old support pages stay heavily indexed."
  },
  {
...
export const faq = [
  {
    "q": "Are all trendnet 10gbe switches models currently sold and supported?",
