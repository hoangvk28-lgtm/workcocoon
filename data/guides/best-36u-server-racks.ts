export const guideSlug = "best-36u-server-racks";
export const guideTitle = "5 Best 36U Server Racks in 2026";
export const metaTitle = "Best 36U Server Racks 2026";
export const metaDescription = "We compared 36u server racks by documented weight rating, mounting depth, and post configuration rather than ranking by U-height alone.";
export const mainKeyword = "36u server racks";
export const introParagraphs = [
  "Choosing among 36u server racks means starting with verifying adjustable depth range covers real server length rather than trusting the nominal size rather than star rating alone.",
...
export const heroImage = "https://m.media-amazon.com/images/I/41NJF2Bh0lS._SL500_.jpg";
...
export const howToChoose: HowToChooseSection[] = [
  {
    ...
    "note": "Confirm 36u server racks's mounting depth or adjustable depth range independently of its U-height, since two racks at the same height can fit very different equipment lengths."
  },
  {
...
export const buyingCriteria = [
  {
    ...
    "explanation": "Confirm 36u server racks's mounting depth or adjustable depth range independently of its U-height, since two racks at the same height can fit very different equipment lengths."
  },
  {
...
export const faq = [
  {
    "q": "Does U-height alone tell me whether 36u server racks will fit my server?",
