...
export default async function WorkBetterGuidePage({ params }: Props) {
  const { slug } = await params;
  ...
  // Guard: a guide only renders under /work-better if it actually belongs to the
  // migrated Work Better category/subcategories — anything else 404s here rather
