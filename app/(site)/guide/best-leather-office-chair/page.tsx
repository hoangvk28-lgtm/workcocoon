...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-leather-office-chair";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-leather-office-chair",
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-leather-office-chair` },
    about: [{"@type":"Thing","name":"Leather Office Chair"},{"@type":"Thing","name":"Genuine Leather Chair"},{"@type":"Thing","name":"Executive Leather Chair"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Leather Office Chairs", item: `${SITE_URL}/guide/best-leather-office-chair` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-leather-office-chair#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Leather Office Chairs</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Leather Office Chairs" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>A leather office chair delivers a professional aesthetic that mesh chairs cannot replicate - the material type (genuine, PU, or bonded leather) determines how long the surface holds up over years of daily use.</p>
          <p>This guide covers eight leather office chairs ranked by leather type (genuine vs PU), ergonomic adjustability, reclining features, and price - from budget tufted options under $190 to premium Steelcase genuine leather.</p>
          <p>For mesh chairs that prioritize breathability over aesthetics, see our <a href='/guide/best-mesh-office-chair' className='text-brand hover:underline'>best mesh office chairs</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=leather+office+chair+genuine+PU+ergonomic&tag=deskfinds0d-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
