...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-office-chair-under-500";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-office-chair-under-500",
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-office-chair-under-500` },
    about: [{"@type":"Thing","name":"Office Chair Under $500"},{"@type":"Thing","name":"Mid-Range Ergonomic Chair"},{"@type":"Thing","name":"Office Chair"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Office Chairs Under $500", item: `${SITE_URL}/guide/best-office-chair-under-500` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-office-chair-under-500#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Office Chairs Under $500</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Office Chairs Under $500" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>An office chair under $500 sits at the upper boundary of the mid-range tier - you can get full ergonomic adjustability, quality mesh, and 5 to 7-year warranties without crossing into the $1,000-plus premium brand territory.</p>
          <p>This guide covers eight office chairs under $500 ranked by adjustment axis count, warranty, leather vs mesh, and user-size specificity - from the Branch Tall at $499 with a 7-year warranty to the HON Ignition 2.0 in genuine leather at $449.</p>
          <p>For budget options under $300, see our <a href='/guide/best-office-chair-under-300' className='text-brand hover:underline'>best office chairs under $300</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=ergonomic+office+chair+under+500+mid+range&tag=deskfinds0d-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
