...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-office-chair-under-300";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-office-chair-under-300",
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-office-chair-under-300` },
    about: [{"@type":"Thing","name":"Office Chair Under $300"},{"@type":"Thing","name":"Budget Ergonomic Chair"},{"@type":"Thing","name":"Affordable Office Chair"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Office Chairs Under $300", item: `${SITE_URL}/guide/best-office-chair-under-300` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-office-chair-under-300#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Office Chairs Under $300</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Office Chairs Under $300" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>A good ergonomic office chair under $300 should include adjustable lumbar height (not just depth), a seat height range that fits your body, and a warranty of at least 3 years - all three are achievable at this budget.</p>
          <p>This guide covers eight office chairs under $300 ranked by adjustability, warranty length, mesh vs padded construction, and price - from the Branch Ergonomic at $299 with a 7-year warranty to the Hbada white mesh under $190.</p>
          <p>If you are looking to step up the quality, see our <a href='/guide/best-office-chair-under-500' className='text-brand hover:underline'>best office chairs under $500</a> guide for mid-range options.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=ergonomic+office+chair+under+300&tag=deskfinds0d-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
