...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-office-chair-for-tall-person";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-office-chair-for-tall-person",
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-office-chair-for-tall-person` },
    about: [{"@type":"Thing","name":"Office Chair for Tall Person"},{"@type":"Thing","name":"High Seat Office Chair"},{"@type":"Thing","name":"Ergonomic Chair for Tall Users"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Office Chairs for Tall People", item: `${SITE_URL}/guide/best-office-chair-for-tall-person` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-office-chair-for-tall-person#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Office Chairs for Tall People</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Office Chairs for Tall People" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>An office chair for tall people needs a seat height range reaching 19 to 21 inches minimum, a back panel tall enough to support the shoulder blade area, and armrests that adjust high enough for extended arm positions.</p>
          <p>This guide covers eight office chairs for tall users ranked by seat height maximum, back height, lumbar position adjustability, and price - from budget under $250 to premium ergonomic options.</p>
          <p>If you also use a standing desk, see our <a href='/guide/best-standing-desk-for-tall-person' className='text-brand hover:underline'>best standing desks for tall people</a> guide to pair the right desk with your chair.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=office+chair+tall+person+high+seat&tag=deskfinds0d-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
