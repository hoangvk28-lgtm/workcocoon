...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-gaming-chair-for-kids";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-gaming-chair-for-kids",
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-gaming-chair-for-kids` },
    about: [{"@type":"Thing","name":"Best Gaming Chairs for Kids"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Gaming Chairs for Kids", item: `${SITE_URL}/guide/best-gaming-chair-for-kids` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-gaming-chair-for-kids#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Gaming Chairs for Kids</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Gaming Chairs for Kids" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>Kids' gaming chairs range from scaled-down recliners with RGB lighting to simple floor rockers built for smaller bodies, and picking the right style depends heavily on your child's age and how they actually use the chair.</p>
          <p>We evaluated eight kids' gaming chairs based on age fit, weight capacity, recline range, and included comfort features like footrests and lumbar pillows, covering options from toddler-friendly floor seats to teen-sized recliners.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=gaming+chair+for+kids&tag=deskfinds0d-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
