...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-office-chair-for-back-pain";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-office-chair-for-back-pain",
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-office-chair-for-back-pain` },
    about: [{"@type":"Thing","name":"Office Chair for Back Pain"},{"@type":"Thing","name":"Lumbar Support Chair"},{"@type":"Thing","name":"Ergonomic Chair"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Office Chairs for Back Pain", item: `${SITE_URL}/guide/best-office-chair-for-back-pain` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-office-chair-for-back-pain#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Office Chairs for Back Pain</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Office Chairs for Back Pain" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>An office chair for back pain relief needs adjustable lumbar height (not just depth), correct seat depth to support proper pelvic tilt, and a dynamic mechanism that allows micro-movements rather than locking you in one posture.</p>
          <p>This guide covers eight office chairs for back pain ranked by lumbar adjustability, back mechanism design, seat depth, and price - from budget under $280 to clinically-informed Herman Miller and HAG Capisco designs.</p>
          <p>If sciatica or disc compression is the specific concern, see our <a href='/guide/best-executive-office-chair' className='text-brand hover:underline'>executive office chairs</a> guide for saddle and coccyx cutout options.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=office+chair+back+pain+lumbar+support+ergonomic&tag=deskfinds0d-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
