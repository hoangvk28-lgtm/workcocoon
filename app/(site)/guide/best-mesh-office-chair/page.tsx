...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-mesh-office-chair";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-mesh-office-chair",
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-mesh-office-chair` },
    about: [{"@type":"Thing","name":"Mesh Office Chair"},{"@type":"Thing","name":"Breathable Ergonomic Chair"},{"@type":"Thing","name":"Mesh Back Office Chair"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Mesh Office Chairs", item: `${SITE_URL}/guide/best-mesh-office-chair` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-mesh-office-chair#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Mesh Office Chairs</span>
        </nav>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Mesh Office Chairs" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>A mesh office chair circulates air through the back and seat surface rather than trapping heat against the body - this makes mesh the practical choice for users in warm offices or those who sit 6-plus hours daily.</p>
          <p>This guide covers eight mesh office chairs ranked by mesh quality, lumbar adjustability, breathability, and price - from the Herman Miller Aeron 8Z Pellicle benchmark at $1,695 to budget mesh options under $190.</p>
          <p>For leather alternatives that provide a traditional executive look, see our <a href='/guide/best-leather-office-chair' className='text-brand hover:underline'>best leather office chairs</a> guide.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=mesh+office+chair+ergonomic+breathable&tag=deskfinds0d-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
