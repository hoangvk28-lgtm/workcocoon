...
import {
  ...
  buyingCriteria,
  type GuideProduct,
} from "@/data/guides/best-office-chair-for-short-people";
...
export const metadata: Metadata = buildMetadata({
  ...
  path: "/guide/best-office-chair-for-short-people",
...
export default async function Page() {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: { "@type": "WebPage", "@id": `${SITE_URL}/guide/best-office-chair-for-short-people` },
    about: [{"@type":"Thing","name":"Office Chair for Short People"},{"@type":"Thing","name":"Low Seat Office Chair"},{"@type":"Thing","name":"Ergonomic Chair for Petite Users"}],
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Best Office Chairs for Short People", item: `${SITE_URL}/guide/best-office-chair-for-short-people` },
    ],
  };
  ...
  const itemListSchema = {
    ...
    itemListElement: products.map((p) => ({
      ...
      position: p.rank,
      name: `${p.name} - ${p.badge}`,
      url: `${SITE_URL}/guide/best-office-chair-for-short-people#${p.id}`,
    })),
  };
    ...
    <>
      ...
      <Container className="py-12 max-w-4xl">
        <nav className="flex items-center gap-1.5 text-xs text-ink-muted mb-6">
          ...
          <span>/</span>
          <span className="text-ink">Best Office Chairs for Short People</span>
        </nav>
        ...
        <header className="mb-8">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-5 pt-5 border-t border-border">
            ...
            <div className="flex items-center gap-1.5 text-xs text-ink-muted">
              ...
              {products.length} chairs evaluated
            </div>
          </div>
        </header>
        ...
        <div className="rounded-2xl overflow-hidden border border-border mb-10 bg-bg">
          <Image src={heroImg} alt="Best Office Chairs for Short People" width={900} height={420} className="w-full h-auto object-contain" priority unoptimized />
        </div>
        ...
        <section className="mb-10 space-y-4 text-base text-ink-secondary leading-relaxed">
          <p>An office chair for short people needs a seat height minimum of 16 inches or lower to allow feet to rest flat on the floor with knees at 90 degrees - standard chairs that start at 17 to 18 inches leave short users sitting too high.</p>
          <p>This guide covers eight office chairs for short users ranked by minimum seat height, seat depth adjustability for shorter thighs, lumbar height configurability, and price.</p>
          <p>For chairs with the smallest purposefully sized seat pan for short frames, see our <a href='/guide/best-office-chair-under-300' className='text-brand hover:underline'>best office chairs under $300</a> guide for budget options that also fit shorter users.</p>
        </section>
        ...
        <section className="mb-14 p-6 rounded-2xl flex flex-col items-center text-center" style={{ background: "linear-gradient(135deg, #FF9900 0%, #e68900 100%)" }}>
          ...
          <a href={`https://www.amazon.com/s?k=office+chair+short+person+low+seat+height&tag=deskfinds0d-20`} target="_blank" rel="noopener noreferrer sponsored" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white font-bold text-sm hover:bg-gray-50 transition-colors" style={{ color: "#FF9900" }}>
            Shop on Amazon &rarr;
          </a>
        </section>
